...
GHCR by default. Set `CONTROL_PLANE_IMAGE=dobria/zt-control-plane:0.1.4` if you
prefer Docker Hub.
...
The release Compose file pins the full `0.1.4` image tag. Avoid deploying only
