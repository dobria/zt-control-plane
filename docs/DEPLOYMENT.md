...
GHCR by default. Set `CONTROL_PLANE_IMAGE=dobria/zt-control-plane:0.1.3` if you
prefer Docker Hub.
...
The release Compose file pins the full `0.1.3` image tag. Avoid deploying only
