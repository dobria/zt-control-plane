...
import type { NodeInventorySnapshot } from "@/lib/types";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

let cache: { expiresAt: number; snapshot: NodeInventorySnapshot } | null = null;
let pending: Promise<NodeInventorySnapshot> | null = null;
...
export async function GET(request: Request) {
  try {
    ...
    cache = { expiresAt: Date.now() + 30_000, snapshot };
